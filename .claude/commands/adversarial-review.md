...
- `.claude/knowledge/backend/*`、`.claude/knowledge/frontend/*`（那是"怎么写"，Evaluator 要的是"该怎么判"）
...
- 本次 B 发现"通过 mock 绕开并发验证"的模式被 A 漏了 → 建议在 `.claude/knowledge/testing/standards.md` 里加"Repository 层禁止 Mock"一条
